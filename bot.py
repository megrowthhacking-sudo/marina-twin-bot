...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    if not _is_allowed(user.id):
        ...
        await update.message.reply_text(
            'Извините, этот бот - цифровая копия Марины, он общается в личном чате только с ней. '
            'Если у Вас имеется вопрос к Марине - пишите в нашей с Вами общей группе в одном сообщении: '
            '"Марина и далее свой вопрос" или также в одном сообщении: '
            '"@marina_ai_twin_bot и далее Ваш вопрос". Спасибо! Мне будет приятно с Вами общаться!'
        )
        return
