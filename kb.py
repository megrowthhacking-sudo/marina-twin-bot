...
COUNTRY_MODULES = {
    ...
    # Не-СНГ юрисдикции (добавлены 05.09.2026 по просьбе Марины) — та же логика
    # "подключается только по ключевому слову", но темы шире чисто банковской: платежи,
    # крипто/цифровые активы, корпоративное право и налоги отдельной юрисдикции, важной
    # для группы Altyn/Atlas/BestSwift за пределами СНГ/ЕАЭС.
    "UAE": (
        "ОАЭ",
        "MarinaTwin_KB_LAW_UAE.md",
        ["оаэ", "эмират", "дубай", "абу-даби", "abu dhabi", "dubai", "vara", "difc", "adgm", "dfsa", "cbuae"],
    ),
    "SINGAPORE": (
        "Сингапур",
        "MarinaTwin_KB_LAW_SINGAPORE.md",
        ["сингапур", "singapore", " mas ", "acra", "iras"],
    ),
    "SAUDI_ARABIA": (
        "Саудовская Аравия",
        "MarinaTwin_KB_LAW_SAUDI_ARABIA.md",
        ["саудовск", "эр-рияд", "рияд", "джидда", "sama", "zakat", "закят", "misa"],
    ),
}
